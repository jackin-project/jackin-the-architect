...
COPY --chown=root:root --chmod=444 caveman-config.json /home/agent/.config/caveman/config.json
...
COPY --chown=root:root --chmod=444 token-optimization.md /home/agent/.claude/CLAUDE.md
COPY --chown=root:root --chmod=444 token-optimization.md /home/agent/.codex/AGENTS.md
COPY --chown=root:root --chmod=444 token-optimization.md /home/agent/.config/AGENTS.md
COPY --chown=root:root --chmod=444 token-optimization.md /home/agent/.config/amp/AGENTS.md
COPY --chown=root:root --chmod=444 token-optimization.md /home/agent/.kimi-code/AGENTS.md
