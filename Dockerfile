...
# NOSONAR - agent owns files in its home dir by design; --chmod=444 prevents writes
...
# NOSONAR - agent owns instruction files in its home dir by design; --chmod=444 prevents writes
